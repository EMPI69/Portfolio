...
function createTextTexture(text: string, bgColor = "#000", textColor = "#fff") {
  const size = 512;
...
const TechStack = () => {
  ...
  const textures = useMemo(() => {
    ...
    const htmlTexture = createTextTexture("HTML", "#E44D26", "#ffffff");
    const cssTexture = createTextTexture("CSS", "#264DE4", "#ffffff");
    return [...imageTextures, htmlTexture, cssTexture];
  }, []);
